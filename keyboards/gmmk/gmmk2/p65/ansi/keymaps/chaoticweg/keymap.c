...
#define WEG_CAPS    LT(_FUNC, KC_CAPS)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ├─────────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┴──────┼──────┤
     * │ FL/CAPS │ C/A  │ S/S  │ G/D  │ A/F  │   G  │   H  │ A/J  │ G/K  │ S/L  │ C/;  │   '  │    Enter    │ Null │
     * ├─────────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┴──────┬──────┼──────┤
    ...
    [_BASE] = LAYOUT(
        ...
        WEG_CAPS,  LCTL_T(KC_A), LSFT_T(KC_S), LGUI_T(KC_D), LALT_T(KC_F), KC_G,     KC_H,     RALT_T(KC_J), RGUI_T(KC_K), RSFT_T(KC_L), RCTL_T(KC_SCLN), KC_QUOT,  KC_ENT,             KC_VOLD,
        KC_LSFT,   KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,     KC_N,     KC_M,         KC_COMM,      KC_DOT,       KC_SLSH,         KC_RSFT,            KC_UP,    DF(_GAMING),
